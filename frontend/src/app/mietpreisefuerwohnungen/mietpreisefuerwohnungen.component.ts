...
@Component({
  selector: 'app-mietpreisefuerwohnungen',
  templateUrl: './mietpreisefuerwohnungen.component.html',
  styleUrls: ['./mietpreisefuerwohnungen.component.css']
})
export class MietpreisefuerwohnungenComponent {
  @Input()
...
public addTrigger_savebutton(trigger: Trigger): void {
  if (!this.triggers_savebutton.includes(trigger.id) && trigger.id === '4') {
