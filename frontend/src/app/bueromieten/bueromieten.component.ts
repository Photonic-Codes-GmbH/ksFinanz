...
@Component({
  selector: 'app-bueromieten',
  templateUrl: './bueromieten.component.html',
  styleUrls: ['./bueromieten.component.css']
})
export class BueromietenComponent {
  @Input()
...
public addTrigger_savebutton(trigger: Trigger): void {
  if (!this.triggers_savebutton.includes(trigger.id) && trigger.id === '5') {
