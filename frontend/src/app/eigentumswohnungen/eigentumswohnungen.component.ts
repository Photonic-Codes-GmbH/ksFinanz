...
@Component({
  selector: 'app-eigentumswohnungen',
  templateUrl: './eigentumswohnungen.component.html',
  styleUrls: ['./eigentumswohnungen.component.css']
})
export class EigentumswohnungenComponent {
  @Input()
...
public addTrigger_savebutton(trigger: Trigger): void {
  if (!this.triggers_savebutton.includes(trigger.id) && trigger.id === '2') {
