...
@Component({
  selector: 'app-baugrundstueckefuergewerbe',
  templateUrl: './baugrundstueckefuergewerbe.component.html',
  styleUrls: ['./baugrundstueckefuergewerbe.component.css']
})
export class BaugrundstueckefuergewerbeComponent {
  @Input()
...
public addTrigger_savebutton(trigger: Trigger): void {
  if (!this.triggers_savebutton.includes(trigger.id) && trigger.id === '8') {
