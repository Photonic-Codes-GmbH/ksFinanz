...
@Component({
  selector: 'app-ladenmieten',
  templateUrl: './ladenmieten.component.html',
  styleUrls: ['./ladenmieten.component.css']
})
export class LadenmietenComponent {
  @Input()
...
public addTrigger_savebutton(trigger: Trigger): void {
  if (!this.triggers_savebutton.includes(trigger.id) && trigger.id === '6') {
