...
@Component({
  selector: 'app-renditeobjekte',
  templateUrl: './renditeobjekte.component.html',
  styleUrls: ['./renditeobjekte.component.css']
})
export class RenditeobjekteComponent {
  @Input()
...
public addTrigger_savebutton(trigger: Trigger): void {
  if (!this.triggers_savebutton.includes(trigger.id) && trigger.id === '3') {
