...
@Component({
  selector: 'app-baugrundstuecke',
  templateUrl: './baugrundstuecke.component.html',
  styleUrls: ['./baugrundstuecke.component.scss']
})
export class BaugrundstueckeComponent implements OnInit {
  @Input()
...
public addTrigger_savebutton(trigger: Trigger): void {
  if (!this.triggers_savebutton.includes(trigger.id) && trigger.id === '0') {
