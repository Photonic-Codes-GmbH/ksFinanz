...
@Component({
  selector: 'app-eigenheime',
  templateUrl: './eigenheime.component.html',
  styleUrls: ['./eigenheime.component.css']
})
export class EigenheimeComponent {
  @Input()
...
public addTrigger_savebutton(trigger: Trigger): void {
  if (!this.triggers_savebutton.includes(trigger.id) && trigger.id === '1') {
